    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <section className="mx-auto max-w-6xl px-5 pb-20 sm:px-8 lg:pb-28">
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card className="border-border bg-card/70"><CardContent className="p-6 sm:p-8"><p className="text-xs font-medium uppercase tracking-[0.16em] text-muted-foreground">{page.competitor} is best for</p><p className="mt-4 leading-7 text-muted-foreground">{page.competitorBestFor}</p></CardContent></Card>
        </div>

        <div className="mt-6 overflow-hidden rounded-2xl border border-border">
          <div className="hidden grid-cols-[0.8fr_1.1fr_1.1fr] gap-5 border-b border-border bg-muted/70 px-5 py-4 text-xs font-medium text-muted-foreground md:grid"><span>Capability</span><span>Editing App</span><span>{page.competitor}</span></div>
