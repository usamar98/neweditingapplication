...
4. Add that value to Vercel as `GOOGLE_SITE_VERIFICATION` for Production, Preview, and Development as appropriate.
...
2. `https://www.editingapp.live/features/ai-video-editor`
3. `https://www.editingapp.live/features/ai-video-generator`
4. `https://www.editingapp.live/tools/product-url-to-video`
5. `https://www.editingapp.live/tools/long-video-to-shorts`
6. `https://www.editingapp.live/ai-video-models`
